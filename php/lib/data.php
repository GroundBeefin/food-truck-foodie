...
$truck = new Truck(generateUuidV4(), $truck->getTruckId(), "https://www.ilovesupper.com/?lightbox=imagem1l", "leonela.naguti+4@gmail.com", "Comfort Food", "https://www.ilovesupper.com/menu", "The Supper Truck", "505.796.2181", null);

$truck2 = new Truck(generateUuidV4(), $truck2->getTruckId(), "https://s3-media0.fl.yelpcdn.com/bphoto/jRMk8IwrTxC92VIO0fpK7g/o.jpg", "leonela.naguti+3@gmail.com", "Mexican", "https://s3-media0.fl.yelpcdn.com/bphoto/3gX7YZxFBqlYG-JT6k96mw/o.jpg", "Taco Bus", "(505) 301-7512", null);

$truck3 = new Truck(generateUuidV4(), $truck3->getTruckId(), "http://box5352.temp.domains/~diadelo2/wp-content/uploads/2019/04/DDLT-LogoR.jpg", "leonela.naguti+1@gmail.com", "Mexican", "https://s3-media0.fl.yelpcdn.com/bphoto/BQZUZ_hKFvaNhnHVOXgVYQ/o.jpg", "Dia De Los Takos", "(505) 550-8540", null);
...
$post = new Post(generateUuidV4(), $truck2->getTruckId(), $user2->getUserId(), "This another post for a food truck", $newPostDatetime = null);

$post = new Post(generateUuidV4(), $truck3->getTruckId(), $user3->getUserId(), "This a third post for a food truck", $newPostDatetime = null);
